    ...
    <div class="c-breadcrumb u-mt-12">
      <div class="l-inner">
        <ul class="c-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          <li class="c-breadcrumb__item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
            <a class="c-breadcrumb__link" itemprop="item" href="/about/"><span itemprop="name">導入事例</span></a>
      ...
      <div class="l-inner">
        ...
        <nav class="p-case-nav">
          <ul class="p-case-nav__list">
            <li class="p-case-nav__item"><a href="#english" class="p-case-nav__link">ビジネス英語研修</a></li>
            <li class="p-case-nav__item"><a href="#communication" class="p-case-nav__link">異文化コミュニケーション</a></li>
            <li class="p-case-nav__item"><a href="#abroad" class="p-case-nav__link">ビジネス学習プログラム</a></li>
          </ul>
        </nav>
        <!--導入事例ナビゲーション-->
        <!--
          ...
          -->
        <!--ビジネス英語研修-->
        <section id="english" class="p-case-summary">
          ...
          <article class="p-case-summary__items">
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                <div class="p-case-summary-item__heading">
                  <p class="p-case-summary-item__business">Webマーケティング事業</p>
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case01.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
            ...
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                <div class="p-case-summary-item__heading">
                  <p class="p-case-summary-item__business">メディカルフィットネス事業</p>
                  <p class="p-case-summary-item__name">
                    FFF株式会社
                    <span class="p-case-summary-item__mr">様</span>
                  </p>
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case02.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
            ...
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                <div class="p-case-summary-item__heading">
                  <p class="p-case-summary-item__business">ソフトウェア開発事業</p>
                  <p class="p-case-summary-item__name">
                    株式会社EEE
                    <span class="p-case-summary-item__mr">様</span>
                  </p>
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case03.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
            ...
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                <div class="p-case-summary-item__heading">
                  <p class="p-case-summary-item__business">飲食事業</p>
                  <p class="p-case-summary-item__name">
                    HHH株式会社
                    <span class="p-case-summary-item__mr">様</span>
                  </p>
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case04.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
        ...
        <!--/ビジネス英語研修-->
        <!--異文化コミニュケーション-->
        <section id="communication" class="p-case-summary">
          <h2 class="p-case-summary__title">
            異文化コミュニケーション
            <span class="p-case-summary__title-foot u-font-italic">
          ...
          <article class="p-case-summary__items">
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                <div class="p-case-summary-item__heading">
                  <p class="p-case-summary-item__business">スポーツ用品開発事業</p>
                  <p class="p-case-summary-item__name">
                    合同会社BBB
                    <span class="p-case-summary-item__mr">様</span>
                  </p>
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case05.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
            ...
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                <div class="p-case-summary-item__heading">
                  <p class="p-case-summary-item__business">アパレル事業</p>
                  <p class="p-case-summary-item__name">
                    DDD株式会社
                    <span class="p-case-summary-item__mr">様</span>
                  </p>
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case06.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
            ...
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case07.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
        ...
        <!--/異文化コミニュケーション-->
        <!--ビジネス留学プログラム-->
        <section id="abroad" class="p-case-summary">
          <h2 class="p-case-summary__title">
            ビジネス留学プログラム
            <span class="p-case-summary__title-foot u-font-italic">
          ...
          <article class="p-case-summary__items">
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case08.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
            ...
            <div class="p-case-summary-item">
              <div class="p-case-summary-item__head">
                ...
                <p class="p-case-summary-item__logo">
                  <img data-src="<?php echo get_template_directory_uri(); ?>/img/common/img-case09.png" alt="導入事例ロゴ" class="p-case-summary-item__img lazyload">
                </p>
              </div>
              <div class="p-case-summary-item__body">
                <h3 class="p-case-summary-item__title">
