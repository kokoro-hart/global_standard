    ...
    <main>
      <div class="p-lower-mv">
        ...
        <picture class="p-lower-mv__picture">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/img/common/mv-company_pc.jpeg" class="p-lower-mv__img" media="(min-width: 768px)" decoding="async" alt="当社についてメインビジュアル">
        </picture>
